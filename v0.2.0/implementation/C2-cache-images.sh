...
# InfoMetis v0.2.0 Container Image Cache Creation Script
...
# Container images used in v0.2.0 (includes v0.1.0 + Registry)
IMAGES=(
...
echo "🚀 InfoMetis v0.2.0 Container Image Cache Creation"
echo "================================================="
...
cache_images() {
    ...
    if [[ ${#failed_images[@]} -gt 0 ]]; then
        ...
        echo ""
        echo "📋 Next steps:"
        echo "  • Use './C2-cache-images.sh load' to load images"
        echo "  • Run './D1-deploy-v0.1.0-foundation.sh' to deploy foundation"
