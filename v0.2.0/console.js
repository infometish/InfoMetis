...
function showMainMenu() {
    ...
    console.log('\nOptions:');
    console.log('• Enter section letter to browse steps');
    console.log('• Type "a" for full sequential execution');
...
function showSectionMenu(section) {
    ...
    console.log('• Type "a" for section sequential execution');
    console.log('• Type "b" to return to main menu');
    console.log('• Type "q" to quit');
