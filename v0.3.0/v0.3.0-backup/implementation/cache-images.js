...
class CacheManager {
    constructor() {
        ...
        // Container images used in v0.3.0 (loaded from config)
        this.images = null; // Will be loaded from v0.3.0 config
    }
    ...
    async initialize() {
        try {
            ...
            // Build images array from config
            this.images = [
                imageConfig.K0S_IMAGE,
                imageConfig.TRAEFIK_IMAGE,
                imageConfig.NIFI_IMAGE,
                imageConfig.NIFI_REGISTRY_IMAGE
            ];
            ...
            this.logger.config('Cache Configuration', {
                ...
                'K0s Image': imageConfig.K0S_IMAGE,
                'Traefik Image': imageConfig.TRAEFIK_IMAGE,
                'NiFi Image': imageConfig.NIFI_IMAGE,
                'Registry Image': imageConfig.NIFI_REGISTRY_IMAGE
            });
