...
class ConsoleCore {
    constructor() {
        this.logger = new Logger('InfoMetis v0.3.0');
    ...
    async initialize() {
        try {
            this.logger.header('InfoMetis v0.3.0 Console', 'Native JavaScript Implementation');
    ...
    async checkPrerequisites() {
        ...
        const checks = [
            ...
            { name: 'kubectl', check: () => this.kubectl.isAvailable() }
        ];
